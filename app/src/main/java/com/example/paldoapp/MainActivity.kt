...
class MainActivity : AppCompatActivity() {
    ...
    private fun showCongratulationsDialog() {
        AlertDialog.Builder(this)
            .setTitle("🎉 PALDO! 🎉")
            .setMessage("Sana all 500!\nHighlight na naman!")
            .setPositiveButton("Nice ka") { dialog, _ ->
                dialog.dismiss()
            }
            .setCancelable(false)
            .show()
    ...
    private fun createNewEntry(userId: String, totalKilo: Double, totalAmount: Double) {
        ...
        FirebaseFirestore.getInstance()
            ...
            .addOnSuccessListener {
                ...
                // Show congratulations dialog if totalKilo > 500
                if (totalKilo > 500.0) {
    ...
    private fun updateExistingEntry(documentId: String, newTotalKilo: Double, newTotalAmount: Double,
        ...
        FirebaseFirestore.getInstance()
            ...
            .addOnSuccessListener {
                ...
                // Show congratulations dialog if newTotalKilo > 500
                if (newTotalKilo > 500.0) {
                    showCongratulationsDialog()
                }
            }
            .addOnFailureListener { e ->
